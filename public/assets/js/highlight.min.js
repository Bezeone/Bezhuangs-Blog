...
return e.length&&t.length?e[0].offset!==t[0].offset?e[0].offset<t[0].offset?e:t:"start"===t[0].event?e:t:e.length?e:t }function o(e){a+="<" +c(e)+[].map.call(e.attributes,(function(e){ return" "+e.nodename+'="'+s(e.value)+'" '})).join("")+">"}function c(e){
a+=""}function g(e){("start"===e.event?o:c)(e.node)}
...
begin:/<<-?\s*(?=\w+) ,starts:{contains:[s.end_same_as_begin({begin: (\w+) , end: ,classname:"string"})]}},c="{className:"string",begin:/"/,end:/"/," contains:[s.backslash_escape,n,a]};a.contains.push(c);const o="{begin:/\$\(\(/," \)\) ,contains:[{begin: \d+#[0-9a-f]+ ,classname:"number"},s.number_mode,n] },r="s.SHEBANG({binary:"(fish|bash|zsh|sh|csh|ksh|tcsh|dash|scsh)",relevance:10" }),l="{className:"function",begin:/\w[\w\d_]*\s*\(\s*\)\s*\{/,returnBegin:!0," contains:[s.inherit(s.title_mode,{begin: \w[\w\d_]* })],relevance:0};return{ name:"bash",aliases:["sh","zsh"],keywords:{$pattern: \b[a-z._-]+\b keyword:"if then else elif fi for while in do done case esac function", literal:"true false", built_in:"break cd continue eval exec exit export getopts hash pwd readonly return shift test times trap umask unset alias bind builtin caller command declare echo enable help let local logout mapfile printf read readarray source type typeset ulimit unalias set shopt autoload bg bindkey bye cap chdir clone comparguments compcall compctl compdescribe compfiles compgroups compquote comptags comptry compvalues dirs disable disown echotc echoti emulate fc fg float functions getcap getln history integer jobs kill limit log noglob popd print pushd pushln rehash sched setcap setopt stat suspend ttyctl unfunction unhash unlimit unsetopt vared wait whence where which zcompile zformat zftp zle zmodload zparseopts zprof zpty zregexparse zsocket zstyle ztcp" },contains:[r,s.shebang(),l,o,s.hash_comment_mode,i,c,{classname:"",begin: \\" },{classname:"string",begin: ' ,end: },n]}}})()); hljs.registerlanguage("c",(()>{"use strict";function e(e){
...
disableAutodetect:!0,illegal:"",keywords:u,contains:["self",i]},{begin:t.IDENT_RE+"::",keywords:u},{
...
aliases:["cc","c++","h++","hpp","hh","hxx","cxx"],keywords:m,illegal:"",keywords:m,contains:["self",s]},{begin:n.IDENT_RE+"::",keywords:m},{
className:"class",beginKeywords:"enum class struct union",end:/[{;:<>=]/,
...
};return{name:"Go",aliases:["golang"],keywords:n,illegal:"{"use strict";function e(...e){
...
name:"Java",aliases:["jsp"],keywords:n,illegal:/<\ |# , contains:[e.comment(" \\*\\*","\\* ",{relevance:0,contains:[{begin: \w+@ relevance:0},{classname:"doctag",begin:"@[a-za-z]+"}]}),{ begin: import java\.[a-z]+\. ,keywords:"import",relevance:2 },e.c_line_comment_mode,e.c_block_comment_mode,e.apos_string_mode,e.quote_string_mode,{ classname:"class",beginkeywords:"class interface enum",end: [{;="]/," excludeend:!0,relevance:1,keywords:"class enum",illegal: [:"\[\]] contains:[{beginkeywords:"extends implements"},e.underscore_title_mode]},{ beginkeywords:"new throw return else",relevance:0},{classname:"class", begin:"record\\s+"+e.underscore_ident_re+"\\s*\\(",returnbegin:!0,excludeend:!0, end: begin:e.underscore_ident_re+"\\s*\\(",returnbegin:!0,relevance:0, contains:[e.underscore_title_mode]},{classname:"params",begin: \( ,end: \) keywords:n,relevance:0,contains:[e.c_block_comment_mode] },e.c_line_comment_mode,e.c_block_comment_mode]},{classname:"function", begin:"([\xc0-\u02b8a-za-z_$][\xc0-\u02b8a-za-z_$0-9]*(<[\xc0-\u02b8a-za-z_$][\xc0-\u02b8a-za-z_$0-9]*(\\s*,\\s*[\xc0-\u02b8a-za-z_$][\xc0-\u02b8a-za-z_$0-9]*)*>)?\\s+)+"+e.UNDERSCORE_IDENT_RE+"\\s*\\(",
...
excludeEnd:!0,relevance:0},{className:"type",begin:/[,:]\s*/,end:/[<\(,]|$ , excludebegin:!0,returnend:!0},l,c]},r,{classname:"meta",begin:"^#! usr bin env", end:"$",illegal:"\n"},o]}}})()); hljs.registerlanguage("less",(()>{"use strict"
...
illegal:"[<=$]",relevance:0,contains:g}}]},v={className:"keyword", begin:"@(import|media|charset|font-face|(-[a-z]+-)?keyframes|supports|document|namespace|page|viewport|host)\\b", starts:{end:"[;{}]",keywords:u,returnend:!0,contains:g,relevance:0}},y="{" classname:"variable",variants:[{begin:"@[\\w-]+\\s*:",relevance:15},{ begin:"@[\\w-]+"}],starts:{end:"[;}]",returnend:!0,contains:f}},k="{variants:[{" begin:"[\\.#:&\\[>]",end:"[;{}]"},{begin:d,end:/\{/}],returnBegin:!0,
returnEnd:!0,illegal:"[<='$\"]",relevance:0, contains:[a.c_line_comment_mode,a.c_block_comment_mode,h,m("keyword","all\\b"),m("variable","@\\{[\\w-]+\\}"),{ begin:"\\b("+e.join("|")+")\\b",classname:"selector-tag" },m("selector-tag",d+"%?",0),m("selector-id","#"+d),m("selector-class","\\."+d,0),m("selector-tag","&",0),s.attribute_selector_mode,{ classname:"selector-pseudo",begin:":("+i.join("|")+")"},{ classname:"selector-pseudo",begin:"::("+o.join("|")+")"},{begin:"\\(",end:"\\)", contains:f},{begin:"!important"}]},e="{begin:`[\\w-]+:(:)?(${l.join("|")})`," returnbegin:!0,contains:[k]} ;return c.push(a.c_line_comment_mode,a.c_block_comment_mode,v,y,e,w,k),{ name:"less",case_insensitive:!0,illegal:"[>'/<($\"]",contains:c}}})()); hljs.registerlanguage("lua",(()>{"use strict";return e=>{
...
className:"meta-string"}),m={endsWithParent:!0,illegal:/`]+/}]}]
...
begin:e(/[a-zA-Z][a-zA-Z_0-9]*/,"\\s+<-\\s+")},{begin:"`",end:"`",contains:[{ begin: \\. }]}]}}})()); hljs.registerlanguage("ruby",(()>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return n=>{
const a="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",i={
...
begin:/<<[-~]?'?(\w+)\n(?:[^\n]*\n)*?\s*\1\b ,returnbegin:!0,contains:[{ begin: <<[-~]?'? },n.end_same_as_begin({begin: (\w+) ,end: , contains:[n.backslash_escape,c]})]}]},g="[0-9](_?[0-9])*" ,d="{className:"number"," relevance:0,variants:[{ begin:`\\b([1-9](_?[0-9])*|0)(\\.(${g}))?([ee][+-]?(${g})|r)?i?\\b`},{ begin:"\\b0[dd][0-9](_?[0-9])*r?i?\\b"},{begin:"\\b0[bb][0-1](_?[0-1])*r?i?\\b" },{begin:"\\b0[oo][0-7](_?[0-7])*r?i?\\b"},{ begin:"\\b0[xx][0-9a-fa-f](_?[0-9a-fa-f])*r?i?\\b"},{ begin:"\\b0(_?[0-7])+r?i?\\b"}]},l="{className:"params",begin:"\\(",end:"\\)"," endsparent:!0,keywords:i},o="[t,{className:"class",beginKeywords:"class" module", end:"$|;",illegal: = ,contains:[n.inherit(n.title_mode,{ begin:"[a-za-z_]\\w*(::\\w+)*(\\?|!)?"}),{begin:"<\\s*",contains:[{ begin:"("+n.ident_re+"::)?"+n.ident_re,relevance:0}]}].concat(b)},{ classname:"function",begin:e( def\s+ ,(_="a+"\\s*(\\(|;|$)",e("(?=",_,")")))," relevance:0,keywords:"def",end:"$|;",contains:[n.inherit(n.title_mode,{begin:a }),l].concat(b)},{begin:n.ident_re+"::"},{classname:"symbol", begin:n.underscore_ident_re+"(!|\\?)?:",relevance:0},{classname:"symbol", begin:":(?!\\s)",contains:[t,{begin:a}],relevance:0},d,{classname:"variable", begin:"(\\$\\w)|((\\$|@@?)(\\w+))(?="[^@$?])(?![A-Za-z])(?![@$?'])"},{" classname:"params",begin: \| ,relevance:0,keywords:i},{ begin:"("+n.re_starters_re+"|unless)\\s*",keywords:"unless",contains:[{ classname:"regexp",contains:[n.backslash_escape,c],illegal: \n ,variants:[{ begin:" ",end:" [a-z]*"},{begin: %r\{ \}[a-z]* },{begin:"%r\\(", end:"\\)[a-z]*"},{begin:"%r!",end:"![a-z]*"},{begin:"%r\\[",end:"\\][a-z]*"}] }].concat(r,b),relevance:0}].concat(r,b);var _;c.contains="o,l.contains=o" ;const e="[{begin:/^\s*=">/,starts:{end:"$",contains:o}},{className:"meta",
...
case_insensitive:!0,illegal:/[{}]|<\ ,keywords:{$pattern: \b[\w\.]+ , keyword:((e,{exceptions:r,when:t}="{})=">{const n=t
;return r=r||[],e.map((e=>e.match(/\|\d+$/)||r.includes(e)?e:n(e)?e+"|0":e))
})(l,{when:e=>e.length<3}),literal:a,type:i, built_in:["current_catalog","current_date","current_default_transform_group","current_path","current_role","current_schema","current_transform_group_for_type","current_user","session_user","system_time","system_user","current_time","localtime","current_timestamp","localtimestamp"] },contains:[{begin:t(...o),keywords:{$pattern: [\w\.]+ ,keyword:l.concat(o), literal:a,type:i}},{classname:"type", begin:t("double precision","large object","with timezone","without timezone") },u,{classname:"variable",begin: @[a-z0-9]+ },{classname:"string",variants:[{ begin: ' ,end: ,contains:[{begin: '' }]}]},{begin: " ,contains:[{ "" }]},e.c_number_mode,e.c_block_comment_mode,n,{classname:"operator", [-+* =%^~]|&&?|\|\|?|!="?|<(?:=">?|<|>)?|>[>=]?/,relevance:0}]}}})());
...
begin://,keywords:D,contains:[...v,...B,...q,M,U]};U.contains.push(Z)
...
begin://,contains:[...v,U]},V={begin:/\(/,end:/\)/,keywords:D,
...
},b=(i=>{const c=e,o={begin:/<[A-Za-z0-9\\._:-]+ , end: \ [a-za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(e,n)=>{
...
aliases:["yml"],contains:b}}})());</"+a+"></%[%=-]?",end:"[%-]?%></\></"!==s?"></[A-Za-z0-9\\._:-]+></(])></|></3}),literal:a,type:i,></\></[-~]?'?(\w+)\n(?:[^\n]*\n)*?\s*\1\b></",end:"></=></|></-\\s+")},{begin:"`",end:"`",contains:[{></\></\?(php|=)?></[></\?php></",end:"></\></\></\></\></script(?=\s|></\></style(?=\s|></\?xml></($\"]",contains:c}}})());></='$\"]",relevance:0,></=$]",relevance:0,contains:g}}]},v={className:"keyword",></\(,]|$></"!==s?"></[A-Za-z0-9\\._:-]+></\></.+></.+></"+e.IDENT_RE+"(\\s*,\\s*"+e.IDENT_RE+")*></",end:"></.*?></[^<></.*?></[^<></-?\s*(?=\w+)></\></[^></br[></unnamed></[^></t[0].offset?e:t:"start"===t[0].event?e:t:e.length?e:t></|<<=|<=|<|===|==|=|></span>